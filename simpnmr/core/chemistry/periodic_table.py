...
# Period 4
d_block_row_1 = ["Sc", "Ti", "V", "Cr", "Mn", "Fe", "Co", "Ni", "Cu", "Zn"]

# Period 5
d_block_row_2 = ["Y", "Zr", "Nb", "Mo", "Tc", "Ru", "Rh", "Pd", "Ag", "Cd"]

# Period 6
d_block_row_3 = ["Hf", "Ta", "W", "Re", "Os", "Ir", "Pt", "Au", "Hg"]

# Period 7
d_block_row_4 = ["Rf", "Db", "Sg", "Bh", "Hs", "Mt", "Ds", "Rg", "Cn"]

# All d-block elements
d_block = d_block_row_1 + d_block_row_2 + d_block_row_3 + d_block_row_4

# Transition metals (alias)
